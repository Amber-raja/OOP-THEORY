...
billType::billType(string patientID1, double pharmacyCharges1, double doctorFee1, double roomCharges1)
{
    patientID = patientID1;
    pharmacyCharges = pharmacyCharges1;
    doctorFee = doctorFee1;
    roomCharges = roomCharges1;
    totalCharges = pharmacyCharges + doctorFee + roomCharges;
}

void billType::setPatientID(string patientID1)
{
    patientID = patientID1;
}

void billType::setPharmacyCharges(double pharmacyCharges1)
{
    pharmacyCharges = pharmacyCharges1;
}

void billType::setDoctorFee(double doctorFee1)
{
    doctorFee = doctorFee1;
}

void billType::setRoomCharges(double roomCharges1)
{
    roomCharges = roomCharges1;
}

void billType::setTotalCharges(double totalCharges1)
{
    totalCharges = totalCharges1;
}
...
void billType::print() const
{
    ...
    cout << "Room's Charges: " << roomCharges << endl;
...
patientType::patientType(string first, string last, string patientID1, int age1) : personType(first, last)
{
    patientID = patientID1;
    age = age1;
}

void patientType::setPatientID(string patientID1)
{
    patientID = patientID1;
}
...
{
    cout << "Patient's Name: " << getFirstName() << " " << getLastName() << endl;
...
int main()
{
    ...
    while (true)
    {
        ...
        case 1:
        {
            ...
            cin >> first;
            cout << "Enter last name of the patient: ";
            cin >> last;
            ...
            cin >> month >> day >> year;
            cout << "Enter patient's discharge date : ";
            cin >> month >> day >> year;
